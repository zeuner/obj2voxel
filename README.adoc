...
.`-o (ply|qef|vl32|vox|xyzrgb|xyzrgbn)`
[%collapsible]
====
...
[%collapsible]
====
XYZRGBN is XYZRGB with additional normals information.
====
...
Certain output formats like PLY, VL32, XYZRGB and XYZRGBN can be streamed, meaning that obj2voxel will consume very little memory when producing them.
